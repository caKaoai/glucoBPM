...
import 'details_anlyze_screen_model.dart';
export 'details_anlyze_screen_model.dart';

class DetailsAnlyzeScreenWidget extends StatefulWidget {
  const DetailsAnlyzeScreenWidget({
    super.key,
  ...
  static String routeName = 'DetailsAnlyzeScreen';
  static String routePath = '/detailsAnlyzeScreen';

  @override
  State<DetailsAnlyzeScreenWidget> createState() =>
      _DetailsAnlyzeScreenWidgetState();
}

class _DetailsAnlyzeScreenWidgetState extends State<DetailsAnlyzeScreenWidget>
    with TickerProviderStateMixin {
  late DetailsAnlyzeScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsAnlyzeScreenModel());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '5rh58q2v' /* AI Nutrition Analysis */,
            ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'zdonybrl' /* IDENTIFIED INGREDIENTS */,
                                            ),
                        ...
                        children: List.generate(daibInsights.length,
                          ...
                          return wrapWithModel(
                            ...
                            child: DiabeticInsightWidget(
                              key: Key(
                                'Key11w_${daibInsightsIndex.toString()}',
                              ),
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.insertMeal =
                              await MealGroup.insertMealCall.call(
                            imageUrl: _model.mealParsInfo?.imageUrl,
                            name: _model.mealParsInfo?.name,
                            language: _model.mealParsInfo?.language,
                            ...
                            diabeticInsightsJson: _model
                                ...
                                .map((e) => e.toMap())
                                .toList(),
                            createdAt: _model.userMealTime != null
                                ? getJsonField(
                                    _model.userMealTime,
                                    r'''$.time''',
                                  ).toString()
                          ...
                          if ((_model.insertMeal?.succeeded ?? true)) {
