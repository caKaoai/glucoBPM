...
import 'b_m_iinfo_model.dart';
export 'b_m_iinfo_model.dart';
...
class _BMIinfoWidgetState extends State<BMIinfoWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BMIinfoModel());
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text:
                              'In which: Weight unit is kg, height unit is meter.',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
