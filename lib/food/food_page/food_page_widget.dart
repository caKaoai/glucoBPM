                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final foodInfo = functions
                                  .filterMeal(FFAppState()
                                      .MealInfo
                                      .sortedList(
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children:
                                List.generate(foodInfo.length, (foodInfoIndex) {
                              final foodInfoItem = foodInfo[foodInfoIndex];
                              return wrapWithModel(
                                model: _model.foodCompModels.getModel(
                                  foodInfoIndex.toString(),
                                  foodInfoIndex,
                                ),
                                updateCallback: () => safeSetState(() {}),
                                updateOnChange: true,
                                child: FoodCompWidget(
                                  key: Key(
                                    'Key2gm_${foodInfoIndex.toString()}',
                                  ),
                                  mealinfo: foodInfoItem,
                                ),
                              );
                            }).divide(SizedBox(height: 16.0)),
                          );
