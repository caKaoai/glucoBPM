...
import '/home/move_goal/move_goal_widget.dart';
...
class StepCounterWidget extends StatefulWidget {
  ...
  static String routeName = 'StepCounter';
  static String routePath = '/stepCounter';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Builder(
            key: ValueKey(FFAppState().HealthPermission.steps.toString()),
            builder: (context) {
              if ((FFAppState().HealthPermission != null) &&
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            CircularPercentIndicator(
                                              percent: functions.stepProgress(
                                                  FFAppState()
                                                      .userData
                                                      .goalSteps,
                                                  valueOrDefault<int>(
                                              ...
                                              progressColor: Color(0xFFFFA63D),
                                              backgroundColor:
                                                  Color(0x26FEBF00),
                                              center: Text(
                                                '0',
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: custom_widgets.BarChartofStep(
                                width: double.infinity,
                                height: 120.0,
                                healthInfo: FFAppState().healthInfo,
                              ),
                            ),
                          ),
                        ),
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 6.0, 0.0, 0.0),
                                  child: Text(
                                    'We need to update your footsteps,\nso we need to connect to Apple Health',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
