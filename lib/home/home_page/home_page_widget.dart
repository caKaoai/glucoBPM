    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Align(
          alignment: AlignmentDirectional(1.0, 0.81),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: custom_widgets.ScrollCircle(
                                      width: double.infinity,
                                      height: 100.0,
                                    ),
                                  ),
                                              ...
                                              children: [
                                                TextSpan(
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'c99cejl4' /* Your metabolic health
is  */
                                                    ,
                                                  ),
                                                  style: FlutterFlowTheme.of(
